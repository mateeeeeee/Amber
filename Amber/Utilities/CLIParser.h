...
namespace amber
{
	...
	public:
		...
		{
			AMBER_ASSERT(has_value);
			if (value == "true" || value == "1") return true;
			if (value == "false" || value == "0") return false;
			AMBER_ASSERT_MSG(false, "Invalid bool argument!");
			AMBER_UNREACHABLE();
		}
	...
	public:
		...
		{
			AMBER_ASSERT_MSG(cli_arg_map.contains(prefix), "Did you forgot to add this Arg to CLIParser?");
	...
	public:
		CLIParser() {}
		AMBER_MAYBE_UNUSED Uint32 AddArg(Bool has_value, std::convertible_to<std::string> auto... prefixes)
		{
		...
		AMBER_NODISCARD CLIParseResult Parse(Int argc, Char** argv);

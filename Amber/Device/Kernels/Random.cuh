...
static __forceinline__ __device__  unsigned int lcg2(unsigned int& prev)
{
...
static __forceinline__ __device__  unsigned int rot_seed(unsigned int seed, unsigned int frame)
{
	return seed ^ frame;
}
